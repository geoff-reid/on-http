...
function httpServiceFactory(
    ...
    function HttpService(endpoint) {
        ...
        this.server = null;
        this.router = injector.get(this.endpoint.router);
        this._setup();
    }
    ...
    HttpService.prototype._setup =  function() {
        ...
        // Mount API Routers
        app.use(/\/api\/(common|current|1\.1)/, this.router);
    ...
    HttpService.prototype._parseEndpoint = function(endpoint) {
        ...
        return {
            ...
            //authEnabled: endpoint.authEnabled,
            router: endpoint.router || "common-api-router"
        };
    };
